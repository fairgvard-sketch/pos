...
`001_foundation.sql` … `070_explicit_device_grants.sql`.
...
- ПЕРЕД разворачиванием кассы на НОВОМ Supabase-проекте обязателен полный
  аудит грантов по всей поверхности приложения и migration с явными GRANT:
  legacy production маскирует их отсутствие, новый проект — нет.
