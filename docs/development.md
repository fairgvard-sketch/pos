...
Сейчас проверяются денежные helpers, i18n, capability-gate, offline scope и
drain, optimistic rollback очереди, landing route, печать длинных чеков и
callback заданий принтера.
