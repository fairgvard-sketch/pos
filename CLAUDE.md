...
**Возможные следующие шаги:** автопечать чека сразу после оплаты (мост позволяет,
диалогов нет); отчёты `/reports` (заглушка); лояльность; офлайн-очередь мутаций
(фаза 7); Cardcom; печать тикетов на кухню (Order tickets из Square).
...
(013–018), табель (022–023), настройки Бизнес/Обслуживание/Сотрудники/Касса.
