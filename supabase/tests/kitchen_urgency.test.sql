...
-- Менеджер с сессией: reorder_menu требует право manage в строгом режиме (090)
INSERT INTO staff (id, org_id, location_id, name, role, pin_hash)
VALUES ('62000000-0000-4000-8000-000000000009',
        '60000000-0000-4000-8000-000000000001',
        '61000000-0000-4000-8000-000000000001',
        'pgTAP manager', 'manager', 'unused-in-test');
INSERT INTO staff_sessions (token, staff_id, org_id, location_id)
VALUES ('62d00000-0000-4000-8000-000000000001',
...
SELECT lives_ok(
  $$SELECT reorder_menu('station',
    ...
    '62d00000-0000-4000-8000-000000000001')$$,
