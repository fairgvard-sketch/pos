...
/**
 * Категория «Оплата» — только device-scoped: способы оплаты, быстрые
 * суммы, звук, чаевые (drill-down), офлайн-очередь. НДС и лояльность —
 * настройки точки, переехали в веб-кабинет ANGLE.
 */
