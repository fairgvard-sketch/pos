 ...
 * Счёт, приготовленный ДО оплаты, закрывает сама оплата (148) — иначе
 * выданный заказ возвращался бы на кухню с готовыми позициями, а при
 * раздельной оплате — двумя карточками с одним номером.
